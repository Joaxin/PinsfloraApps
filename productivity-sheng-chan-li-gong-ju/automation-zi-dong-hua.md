...
![](/assets/plugins.svg) AuftoCorrect for English

### AutoIt v3 [![](/assets/website_official.svg)](https://www.autoitscript.com/site/autoit/)

类`BASIC`脚本语言，用于Windows GUI的自动化, AutoHotKey的替代品

### GestureSign [![](/assets/website_official.svg)](http://gesturesign.win) [![](/assets/github_open.svg)](https://github.com/TransposonY/GestureSign)
