### Cryptomator [![](/assets/website_official.svg)](https://cryptomator.org/) ![](/assets/translation.svg)

> Free client-side encryption for your cloud files.
Open source software: No backdoors, no registration.

![](/assets/download.svg) https://cryptomator.org/downloads/#allVersions

一款免费的跨平台[`Windows` 、`macOS`、 `Linux`、 `Android`、`iOS`]云端文件加密程序。

### ENCRYPTO [![](/assets/website_official.svg)](http://macpaw.com/encrypto)
...
### IIS Crypto [![](/assets/website_official.svg)](https://www.nartac.com/Products/IISCrypto)
