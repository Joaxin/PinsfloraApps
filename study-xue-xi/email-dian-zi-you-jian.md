...
### Mailbird![](/assets/leaves_rec.png)![](/assets/windows.png)![](/assets/translation.png)

界面简洁漂亮，支持whatsapp，wechat，facebook等插件，支持触摸，免费版只能用一个邮箱地址

![](/assets/website_official.png)[https://www.getmailbird.com/](https://www.getmailbird.com/)
...
### Newton![](/assets/money_pay.png)

跨平台，界面漂亮

Email app with space-age features for modern-day business communication.

![](/assets/website_official.png)[https://newtonhq.com/](https://legacy.gitbook.com/book/joaxin/windows-apps-garden/edit#)

### Postbox![](/assets/money_pay.png)

Simple, Clear and Powerful With Beautiful UI

![](/assets/website_official.png) [https://www.postbox-inc.com/](https://www.postbox-inc.com/)

### Thunderbird ![](/assets/github_open.png)
...
大名鼎鼎的 Microsoft Office 组件之一，除了电子邮件，还包含了日历、任务管理、联系人、记事本等功能。
...
### Yomail ![](/assets/time_whathappened.png)
