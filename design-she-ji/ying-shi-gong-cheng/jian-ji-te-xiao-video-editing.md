...
### LosslessCut [![](/assets/website_official.svg)](https://github.com/mifi/lossless-cut) [![](/assets/github_open.svg)](https://github.com/mifi/lossless-cut)

跨平台[`Windows` 、`macOS`、 `Linux``]视频音频文件剪辑工具，ffmpeg的GUI 封装。

### Shotcut [![](/assets/website_official.svg)](https://www.shotcut.org/) [![](/assets/github_open.svg)](https://github.com/mltframework/shotcut)
